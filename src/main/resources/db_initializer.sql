...
INSERT INTO PUBLIC."user" (id, username, password, name, surname, email, enabled, position, goals) VALUES (nextval('user_id_sequence'), 'adminunitleader', '$2a$11$Msstp8c.6ktm4x7Y63QI3ezgnPqFPiuTuMOh.ysCVIbZBJMJL6Aqi', 'Joanna', 'Zaborowska', 'adminunitleader@bar.mail.dummy', true, 'Senior Android Programmer', 'Get to know the new Android 8.0');
INSERT INTO PUBLIC."user" (id, username, password, name, surname, email, enabled, position, goals) VALUES (nextval('user_id_sequence'), 'adminemployee', '$2a$11$Msstp8c.6ktm4x7Y63QI3ezgnPqFPiuTuMOh.ysCVIbZBJMJL6Aqi', 'Emil', 'Gustaffsonn', 'adminemployee@bar.mail.dummy', true, 'Senior Architect', 'Meet with Bill Gates');
INSERT INTO PUBLIC."user" (id, username, password, name, surname, email, enabled, position, goals) VALUES (nextval('user_id_sequence'), 'allroles', '$2a$11$Msstp8c.6ktm4x7Y63QI3ezgnPqFPiuTuMOh.ysCVIbZBJMJL6Aqi', 'Sigur', 'Ross', 'allroles@bar.mail.dummy', true, 'Senior Designer', 'Go to Paris for Nova conference');
