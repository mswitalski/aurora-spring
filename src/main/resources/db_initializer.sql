...
INSERT INTO PUBLIC.evaluation (id, leader_evaluation, leader_explanation, self_evaluation, self_explanation, skill_id, user_id, version) VALUES (nextval('userskill_id_sequence'), 'NONE', 'no leader explanation', 'BEGINNER', 'no self explanation', 1, 2, 0);
INSERT INTO PUBLIC.evaluation (id, leader_evaluation, leader_explanation, self_evaluation, self_explanation, skill_id, user_id, version) VALUES (nextval('userskill_id_sequence'), 'INTERMEDIATE', 'no leader explanation', 'INTERMEDIATE', 'no self explanation', 2, 2, 0);
INSERT INTO PUBLIC.evaluation (id, leader_evaluation, leader_explanation, self_evaluation, self_explanation, skill_id, user_id, version) VALUES (nextval('userskill_id_sequence'), 'EXPERT', 'no leader explanation', 'EXPERT', 'no self explanation', 3, 2, 0);
INSERT INTO PUBLIC.evaluation (id, leader_evaluation, leader_explanation, self_evaluation, self_explanation, skill_id, user_id, version) VALUES (nextval('userskill_id_sequence'), 'BEGINNER', 'no leader explanation', 'BEGINNER', 'no self explanation', 4, 2, 0);
INSERT INTO PUBLIC.evaluation (id, leader_evaluation, leader_explanation, self_evaluation, self_explanation, skill_id, user_id, version) VALUES (nextval('userskill_id_sequence'), 'INTERMEDIATE', 'no leader explanation', 'BEGINNER', 'no self explanation', 5, 3, 0);
INSERT INTO PUBLIC.evaluation (id, leader_evaluation, leader_explanation, self_evaluation, self_explanation, skill_id, user_id, version) VALUES (nextval('userskill_id_sequence'), 'EXPERT', 'no leader explanation', 'BEGINNER', 'no self explanation', 6, 3, 0);
INSERT INTO PUBLIC.evaluation (id, leader_evaluation, leader_explanation, self_evaluation, self_explanation, skill_id, user_id, version) VALUES (nextval('userskill_id_sequence'), 'EXPERT', 'no leader explanation', 'EXPERT', 'no self explanation', 7, 3, 0);
INSERT INTO PUBLIC.evaluation (id, leader_evaluation, leader_explanation, self_evaluation, self_explanation, skill_id, user_id, version) VALUES (nextval('userskill_id_sequence'), 'BEGINNER', 'no leader explanation', 'BEGINNER', 'no self explanation', 8, 3, 0);
INSERT INTO PUBLIC.evaluation (id, leader_evaluation, leader_explanation, self_evaluation, self_explanation, skill_id, user_id, version) VALUES (nextval('userskill_id_sequence'), 'BEGINNER', 'no leader explanation', 'BEGINNER', 'no self explanation', 9, 3, 0);
INSERT INTO PUBLIC.evaluation (id, leader_evaluation, leader_explanation, self_evaluation, self_explanation, skill_id, user_id, version) VALUES (nextval('userskill_id_sequence'), 'INTERMEDIATE', 'no leader explanation', 'INTERMEDIATE', 'no self explanation', 10, 4, 0);
INSERT INTO PUBLIC.evaluation (id, leader_evaluation, leader_explanation, self_evaluation, self_explanation, skill_id, user_id, version) VALUES (nextval('userskill_id_sequence'), 'BEGINNER', 'no leader explanation', 'BEGINNER', 'no self explanation', 11, 4, 0);
INSERT INTO PUBLIC.evaluation (id, leader_evaluation, leader_explanation, self_evaluation, self_explanation, skill_id, user_id, version) VALUES (nextval('userskill_id_sequence'), 'BEGINNER', 'no leader explanation', 'INTERMEDIATE', 'no self explanation', 12, 4, 0);
INSERT INTO PUBLIC.evaluation (id, leader_evaluation, leader_explanation, self_evaluation, self_explanation, skill_id, user_id, version) VALUES (nextval('userskill_id_sequence'), 'INTERMEDIATE', 'no leader explanation', 'INTERMEDIATE', 'no self explanation', 13, 5, 0);
INSERT INTO PUBLIC.evaluation (id, leader_evaluation, leader_explanation, self_evaluation, self_explanation, skill_id, user_id, version) VALUES (nextval('userskill_id_sequence'), 'EXPERT', 'no leader explanation', 'EXPERT', 'no self explanation', 14, 5, 0);
INSERT INTO PUBLIC.evaluation (id, leader_evaluation, leader_explanation, self_evaluation, self_explanation, skill_id, user_id, version) VALUES (nextval('userskill_id_sequence'), 'EXPERT', 'no leader explanation', 'EXPERT', 'no self explanation', 15, 5, 0);
