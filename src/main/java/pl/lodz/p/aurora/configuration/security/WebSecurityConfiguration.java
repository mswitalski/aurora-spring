...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "api/v1/mentors/**/feedback/").hasAnyRole("EMPLOYEE", "UNIT_LEADER")
                ...
                .antMatchers(HttpMethod.DELETE, "api/v1/feedback/**").hasRole("UNIT_LEADER")
                ...
                .antMatchers(HttpMethod.GET, "api/v1/trainings/**").hasAnyRole("EMPLOYEE", "UNIT_LEADER")
                .antMatchers(HttpMethod.DELETE, "api/v1/trainings/**").hasRole("UNIT_LEADER")
                .antMatchers(HttpMethod.PUT, "api/v1/trainings/**").hasRole("UNIT_LEADER")
                ...
                .antMatchers(HttpMethod.GET, "api/v1/users/**/tasks/undone/").hasRole("UNIT_LEADER")
